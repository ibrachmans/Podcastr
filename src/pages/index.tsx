/* SPA:
Ele pode ser utilizado. O problema acontece quando precisamos das informações assim que a pagina seja mostrada ao usuário ao invés de carregadas depois.
...
// Estava usando fetch, mas ele trocou por uma ferramenta axios para deixar o codigo mais limpo. Criamos api.ts e exportamos de lá.
